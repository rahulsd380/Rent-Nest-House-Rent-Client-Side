  ...
  return (
    <div className="">
      ...
      <footer className="footer p-10 text-base-content">
        <aside>
          <img className="w-28" src="https://i.ibb.co/7rX3hSD/logo.png" alt="" />
          <p className="text-white font-semibold">
            <span className="bg-gradient-to-br from-sky-500  to-sky-600 bg-clip-text text-transparent font-bold text-4xl ">Rent Nest</span>
            <br />
      ...
      <hr />
      <br />
      <p className="text-gray-400 text-sm text-center font-semibold">Powered By <span className="text-blue-400">Rahul Sutradhar</span> Rent Rest ltd © 2023</p>
      <br />
